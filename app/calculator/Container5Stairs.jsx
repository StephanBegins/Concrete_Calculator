...
const Container5Stairs = () => (
  <div className="w-full mb-10 max-w-lg bg-white shadow-md rounded-lg p-6 space-y-6">
    <h1 className="text-2xl font-bold text-gray-800 mb-4">Stairs</h1>
    ...
    <LengthInput defaultUnit="meters" />
    <h2 className="text-xl font-semibold text-gray-700 mb-4">Number of Steps</h2>
    <input type="number" placeholder="Enter number of steps" className="w-full px-4 py-2 border rounded-lg" />
...
export default Container5Stairs;
